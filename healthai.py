...
body, .gradio-container {
  background: linear-gradient(135deg, #202025 0%, #14213d 100%);
  color: #fca311;
}
.gr-markdown {
  ...
  padding: 16px;
  border-radius: 16px;
  box-shadow: 0 2px 12px #000a, 0 2px 4px #0003;
...
.gr-button {
  background: linear-gradient(90deg, #fca311 30%, #ff0a5c 100%);
  color: #fff;
  font-weight: bold;
  border-radius: 10px;
  box-shadow: 0 2px 8px #ff0a5c80;
  transition: transform 0.1s;
}
.gr-button:hover {
  transform: scale(1.05);
  background: linear-gradient(90deg, #ff0a5c 40%, #fca311 100%);
}
"""

with gr.Blocks(css=custom_css) as app:
    gr.Markdown("## 🩺 **Medical AI Assistant**\n<span style='color:#fca311;'>Your modern AI-powered medical tool.</span>")
    gr.Markdown("**⚠️ Disclaimer:** <span style='color:#ff0a5c;'>This is for informational purposes only. Always consult healthcare professionals for medical advice.</span>")
